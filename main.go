...
type (
	// AuthHandler Обработчик HTTP-запросов на регистрацию и аутентификацию пользователей
	AuthHandler struct {
		storage *AuthStorage
	}

	// AuthStorage Хранилище зарегистрированных пользователей
...
// RegisterRequest Структура HTTP-запроса на регистрацию пользователя
...
// Register Обработчик HTTP-запросов на регистрацию пользователя
...
// LoginRequest Структура HTTP-запроса на вход в аккаунт
type LoginRequest struct {
	Email    string `json:"email"`
	Password string `json:"password"`
}

// LoginResponse Структура HTTP-ответа на вход в аккаунт
...
// Login Обработчик HTTP-запросов на вход в аккаунт
...
// UserHandler Обработчик HTTP-запросов, которые связаны с пользователем
type UserHandler struct {
	storage *AuthStorage
}

// ProfileResponse Структура HTTP-ответа с информацией о пользователе
...
// Profile Обработчик HTTP-запросов на получение информации о пользователе
